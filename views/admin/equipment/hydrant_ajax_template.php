                     ...
                     <div class ="table-responsive">
                       <table id="<?= 'inspection-'.$inspection->id ?>" class="table inspection table-bordered">
                          <tbody>
                             ...
                             <tr>
                                <td style="width:20%">Jumlah Pilar Hydrant</td>
                                <td style="width:2%">:</td>
                                <td class="<?= $editable_class ?>" data-field="jumlah_pilar_hydrant" data-jenis_pesawat="<?= $inspection->equipment_type ?>" data-inspection_id="<?= $inspection->id ?>" data-task_id="<?= $task->id ?>"><?= isset($equipment['jumlah_pilar_hydrant']) ? $equipment['jumlah_pilar_hydrant'] : '' ?></td>
                             </tr>
                             <tr>
                             ...
                             <tr>
                                <td style="width:20%">Jumlah Jockey Pump</td>
                                <td style="width:2%">:</td>
                                <td class="<?= $editable_class ?>" data-field="jumlah_jokey_pump" data-jenis_pesawat="<?= $inspection->equipment_type ?>" data-inspection_id="<?= $inspection->id ?>" data-task_id="<?= $task->id ?>"><?= isset($equipment['jumlah_jokey_pump']) ? $equipment['jumlah_jokey_pump'] : '' ?></td>
                             </tr>
                             <tr>
                                <td style="width:20%">Jumlah Elektrik Pump</td>
                                <td style="width:2%">:</td>
                                <td class="<?= $editable_class ?>" data-field="jumlah_elektrik_pump" data-jenis_pesawat="<?= $inspection->equipment_type ?>" data-inspection_id="<?= $inspection->id ?>" data-task_id="<?= $task->id ?>"><?= isset($equipment['jumlah_elektrik_pump']) ? $equipment['jumlah_elektrik_pump'] : '' ?></td>
                             </tr>
                             <tr>
                                <td style="width:20%">Jumlah Diesel Pump</td>
                                <td style="width:2%">:</td>
                                <td class="<?= $editable_class ?>" data-field="jumlah_diesel_pump" data-jenis_pesawat="<?= $inspection->equipment_type ?>" data-inspection_id="<?= $inspection->id ?>" data-task_id="<?= $task->id ?>"><?= isset($equipment['jumlah_diesel_pump']) ? $equipment['jumlah_diesel_pump'] : '' ?></td>
                             </tr>
                             <tr>
                             ...
                             <tr>
                                ...
                                <td style="width:20%">Sumber Persediaan Air</td>
                                <td style="width:2%">:</td>
                                <td class="<?= $editable_class ?>" data-field="sumber_persediaan_air" data-jenis_pesawat="<?= $inspection->equipment_type ?>" data-inspection_id="<?= $inspection->id ?>" data-task_id="<?= $task->id ?>"><?= isset($equipment['sumber_persediaan_air']) ? $equipment['sumber_persediaan_air'] : '' ?></td>
                             </tr>
                             <tr>
                                <td style="width:20%">Penggerak Utama</td>
                                <td style="width:2%">:</td>
                                <td class="<?= $editable_class ?>" data-field="penggerak_utama" data-jenis_pesawat="<?= $inspection->equipment_type ?>" data-inspection_id="<?= $inspection->id ?>" data-task_id="<?= $task->id ?>"><?= isset($equipment['penggerak_utama']) ? $equipment['penggerak_utama'] : '' ?></td>
                             </tr>
                             <tr>
