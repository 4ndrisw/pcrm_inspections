<?php defined('BASEPATH') or exit('No direct script access allowed'); ?>
      ...
      <div class="horizontal-scrollable-tabs mbot15">
         ...
         <div class="horizontal-tabs">
            <ul class="nav nav-tabs nav-tabs-horizontal" role="tablist">
               ...
               <li role="presentation">
                  <a href="#inspection_hydrotest_test" aria-controls="inspection_hydrotest_test" role="tab" data-toggle="tab"><?php echo _l('inspection_hydrotest_test'); ?></a>
               </li>
               <li role="presentation">
      ...
      <div class="tab-content">
                       ...
                       <table id="<?= 'inspection-'.$inspection->id ?>" class="table inspection table-bordered">
                          <tbody>
                             ...
                             <tr>
                                ...
                                <td style="width:2%">:</td>
                                <td class="<?= $editable_class ?>" data-field="tekanan_design" data-jenis_pesawat="<?= $inspection->equipment_type ?>" data-inspection_id="<?= $inspection->id ?>" data-task_id="<?= $task->id ?>"><?= isset($equipment['tekanan_design']) ? $equipment['tekanan_design'] : '' ?></td>
                             </tr>
                             <tr>
                             ...
                             <tr>
                                ...
                                <td style="width:2%">:</td>
                                <td class="<?= $editable_class ?>" data-field="tekanan_uji" data-jenis_pesawat="<?= $inspection->equipment_type ?>" data-inspection_id="<?= $inspection->id ?>" data-task_id="<?= $task->id ?>"><?= isset($equipment['tekanan_uji']) ? $equipment['tekanan_uji'] : '' ?></td>
                             </tr>
                             <tr>
                             ...
                             <tr>
                                ...
                                <td style="width:2%">:</td>
                                <td class="<?= $editable_class ?>" data-field="bentuk" data-jenis_pesawat="<?= $inspection->equipment_type ?>" data-inspection_id="<?= $inspection->id ?>" data-task_id="<?= $task->id ?>"><?= isset($equipment['bentuk']) ? $equipment['bentuk'] : '' ?></td>
                             </tr>
                             <tr>
                                <td style="width:20%">Orientasi Boiler</td>
                                <td style="width:2%">:</td>
                                <td class="<?= $editable_class ?>" data-field="orientasi_boiler" data-jenis_pesawat="<?= $inspection->equipment_type ?>" data-inspection_id="<?= $inspection->id ?>" data-task_id="<?= $task->id ?>"><?= isset($equipment['orientasi_boiler']) ? $equipment['orientasi_boiler'] : '' ?></td>
                             </tr>
                             <tr>
                                <td style="width:20%">Luas Pemanasan</td>
                                <td style="width:2%">:</td>
                                <td class="<?= $editable_class ?>" data-field="luas_pemanasan" data-jenis_pesawat="<?= $inspection->equipment_type ?>" data-inspection_id="<?= $inspection->id ?>" data-task_id="<?= $task->id ?>"><?= isset($equipment['luas_pemanasan']) ? $equipment['luas_pemanasan'] : '' ?></td>
                             </tr>
                             <tr>
         ...
         <div role="tabpanel" class="tab-pane" id="inspection_hydrotest_test">
            <h4 class="bold">
               <?php echo _l('inspection_hydrotest_test'); ?>
            </h4>
            <p class="text-muted">
               <p><?php echo _l('inspection_hydrotest_test'); ?></p>
            </p>
            <hr />
            <div class="row">
