...
if(isset($inspection->equipment['pengujian_penetrant']) && $inspection->equipment['pengujian_penetrant'] == 3){
    $pengujian_penetrant_n = '&#9745;';
}
$pengujian_thickness_t = '&#9744;';
if(isset($inspection->equipment['pengujian_thickness']) && $inspection->equipment['pengujian_thickness'] == 1){
    $pengujian_thickness_t = '&#9745;';
}
$pengujian_thickness_f = '&#9744;';
if(isset($inspection->equipment['pengujian_thickness']) && $inspection->equipment['pengujian_thickness'] == 2){
    $pengujian_thickness_f = '&#9745;';
}
$pengujian_thickness_n = '&#9744;';
if(isset($inspection->equipment['pengujian_thickness']) && $inspection->equipment['pengujian_thickness'] == 3){
    $pengujian_thickness_n = '&#9745;';
}
