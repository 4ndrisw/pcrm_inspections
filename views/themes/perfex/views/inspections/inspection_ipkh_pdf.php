...
<table class="table table-bordered">
     <tbody>
        <tr class="tg pemeriksaan_dokumen">
           <td width="32%">$pemeriksaan_dokumen</td>
           <td width="1%">:</td>
        ...
        <tr class="tg pemeriksaan_visual">
           <td width="32%">$pemeriksaan_visual</td>
           <td width="1%">:</td>
        ...
        <tr class="tg pemeriksaan_pengaman">
           <td width="32%">$pemeriksaan_pengaman</td>
           <td width="1%">:</td>
        ...
        <tr class="tg pengujian_pompa">
           <td width="32%">$pengujian_pompa</td>
           <td width="1%">:</td>
        ...
        <tr class="tg pengujian_tekanan">
           <td width="32%">$pengujian_tekanan</td>
           <td width="1%">:</td>
        ...
        <tr class="tg pengujian_daya_pancar">
           <td width="32%">$pengujian_daya_pancar</td>
           <td width="1%">:</td>
        ...
        <tr class="tg pengujian_operasional">
           <td width="32%">$pengujian_operasional</td>
           <td width="1%">:</td>
