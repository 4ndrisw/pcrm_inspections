...
<table class="table table-bordered">
     <tbody>
        ...
        <tr class="tg pengujian_grounding">
           ...
           <td width="20%"><span style='font-size:2.5rem;'>$pengujian_grounding_n</span> $tidak_dilaksanakan</td>
        </tr>
        <tr class="tg pengujian_thermal_infrared">
           ...
           <td width="20%"><span style='font-size:2.5rem;'>$pengujian_thermal_infrared_n</span> $tidak_dilaksanakan</td>
        </tr>
