...
if (!$CI->db->table_exists(db_prefix() . 'elevator')) {
    $CI->db->query('CREATE TABLE `' . db_prefix() . "elevator` (
  `id` int(11) NOT NULL,
  ...
  `pabrik_pembuat` varchar(100) DEFAULT NULL,
  `tempat_pembuatan` varchar(50) DEFAULT NULL,
  ...
  `jumlah_lantai` varchar(20) DEFAULT NULL,
  ...
  `jenis_pemeriksaan` varchar(30) DEFAULT NULL
    ...
    $CI->db->query('ALTER TABLE `' . db_prefix() . 'elevator`
      ADD PRIMARY KEY (`id`),
