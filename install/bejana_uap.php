...
if (!$CI->db->table_exists(db_prefix() . 'bejana_uap')) {
    $CI->db->query('CREATE TABLE `' . db_prefix() . "bejana_uap` (
      `id` int(11) NOT NULL,
      ...
      `tekanan_design` varchar(50) DEFAULT NULL,
    ...
    $CI->db->query('ALTER TABLE `' . db_prefix() . 'bejana_uap`
      ADD PRIMARY KEY (`id`),
