...
if (!$CI->db->table_exists(db_prefix() . 'hydrant')) {
    $CI->db->query('CREATE TABLE `' . db_prefix() . "hydrant` (
      ...
      `pengujian_pompa` tinyint(1) DEFAULT NULL,
      `pengujian_tekanan` tinyint(1) DEFAULT NULL,
      `pengujian_daya_pancar` tinyint(1) DEFAULT NULL,
    ...
    $CI->db->query('ALTER TABLE `' . db_prefix() . 'hydrant`
      ADD PRIMARY KEY (`id`),
