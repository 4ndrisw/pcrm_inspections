...
if (!$CI->db->table_exists(db_prefix() . 'petir')) {
    $CI->db->query('CREATE TABLE `' . db_prefix() . "petir` (
    `id` int(11) NOT NULL,
    ...
    `tinggi_bangunan` varchar(20) DEFAULT NULL,
    `bangunan` varchar(20) DEFAULT NULL,
    `jenis_pesawat` varchar(30) NOT NULL,
    `pabrik_pembuat` varchar(50) DEFAULT NULL,
    `tahun_pemasangan` smallint(4) DEFAULT NULL,
    `jenis_penghantar` varchar(50) DEFAULT NULL,
    `merk` varchar(30) DEFAULT NULL,
    `type_model` varchar(30) DEFAULT NULL,
    `nama_pesawat` varchar(50) DEFAULT NULL,
    `instalatir` varchar(60) DEFAULT NULL,
    `penghantar` varchar(50) DEFAULT NULL,
    `jenis_penyalur` varchar(30) DEFAULT NULL,
    `pembumian` varchar(60) DEFAULT NULL,
    `box_control` varchar(60) DEFAULT NULL,
    `tinggi_tiang_penerima` varchar(40) DEFAULT NULL,
    ...
    $CI->db->query('ALTER TABLE `' . db_prefix() . 'petir`
      ADD PRIMARY KEY (`id`),
